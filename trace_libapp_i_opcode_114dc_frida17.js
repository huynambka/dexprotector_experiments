...
const TRACE_LIBAPP_REFLECTION_RESOLVER = true; // enable only when Java reflection-level resolution is needed
const TRACE_LIBAPP_JNI_RESOLVER = true;        // enable only for short targeted runs; JNIEnv hooks are fragile/noisy
const TRACE_LIBAPP_JAVA_STACK = true;          // stack capture inside dispatcher can perturb protected code
...
const TRACE_LIBAPP_FOCUS_OPCODES = [0x114dc];
const TRACE_LIBAPP_LOG_ALL_CALLS = false;        // if false, only logs focus opcode chains
const libAppTrace = {
  installed: false,
  installing: false,
